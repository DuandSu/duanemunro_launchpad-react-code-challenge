...
const universityCuba = [
    {"alpha_two_code": "CU", 
        "domains": ["cujae.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.cujae.edu.cu/"], 
        "name": "Instituto Superior Polit\u00e9cnico Jos\u00e9 Antonio Echeverr\u00eda"}, 
    {"alpha_two_code": "CU", 
        "domains": ["ismm.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.ismm.edu.cu/"], 
        "name": "Instituto Superior Minero Metal\u00fargico \"Dr. Antonio N\u00fa\u00f1ez Jim\u00e9nez\""}, 
    {"alpha_two_code": "CU", 
        "domains": ["ispcmw.rimed.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.ispcmw.rimed.cu/"], 
        "name": "Universidad Pedag\u00f3gica \"Jos\u00e9 Mart\u00ed\", Camag\u00fcey"}, 
    {"alpha_two_code": "CU", 
        "domains": ["reduc.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.reduc.edu.cu/"], 
        "name": "Universidad de Camag\u00fcey"}, 
    {"alpha_two_code": "CU", 
        "domains": ["ucf.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.ucf.edu.cu/"], 
        "name": "Universidad de Cienfuegos"}, 
    {"alpha_two_code": "CU", 
        "domains": ["uclv.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.uclv.edu.cu/"], 
        "name": "Universidad Central de Las Villas"}, 
    {"alpha_two_code": "CU", 
            "domains": ["udg.co.cu"], 
            "country": "Cuba", 
            "state-province": null, 
            "web_pages": ["http://www.udg.co.cu/"], 
            "name": "Universidad de Granma"}, 
    {"alpha_two_code": "CU", 
        "domains": ["uh.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.uh.cu/"], 
        "name": "Universidad de La Habana"}, 
    {"alpha_two_code": "CU", 
        "domains": ["uho.edu.cu"], 
        "country": "Cuba", "state-province": null, 
        "web_pages": ["http://www.uho.edu.cu/"], 
        "name": "Universidad de Holgu\u00edn"}, 
    {"alpha_two_code": "CU", 
        "domains": ["umcc.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.umcc.cu/"], 
        "name": "Universidad de Matanzas Camilo Cienfuegos"}, 
    {"alpha_two_code": "CU", 
        "domains": ["unica.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.unica.cu/"], 
        "name": "Universidad de Ciego de Avila"}, 
    {"alpha_two_code": "CU", 
        "domains": ["uo.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.uo.edu.cu/"], 
        "name": "Universidad de Oriente"}, 
    {"alpha_two_code": "CU", 
        "domains": ["upr.edu.cu"], 
        "country": "Cuba", 
        "state-province": null, 
        "web_pages": ["http://www.upr.edu.cu/"], 
